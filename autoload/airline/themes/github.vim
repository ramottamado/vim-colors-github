...
function! airline#themes#github#refresh()
  ...
  let g:airline#themes#github#palette.normal = extend(g:airline#themes#github#palette.normal, {
  ...
  let g:airline#themes#github#palette.insert = extend(g:airline#themes#github#palette.insert, {
        \ 'airline_warning': [airline#themes#get_highlight('airlineWarning')],
        \ 'airline_error': [airline#themes#get_highlight('airlineError')],
        \ 'airline_term': [airline#themes#get_highlight('airlineTerm')],
        \ })
  ...
  let g:airline#themes#github#palette.replace = extend(g:airline#themes#github#palette.replace, {
        \ 'airline_warning': [airline#themes#get_highlight('airlineWarning')],
        \ 'airline_error': [airline#themes#get_highlight('airlineError')],
        \ 'airline_term': [airline#themes#get_highlight('airlineTerm')],
        \ })
  ...
  let g:airline#themes#github#palette.visual = extend(g:airline#themes#github#palette.visual, {
        \ 'airline_warning': [airline#themes#get_highlight('airlineWarning')],
        \ 'airline_error': [airline#themes#get_highlight('airlineError')],
        \ 'airline_term': [airline#themes#get_highlight('airlineTerm')],
        \ })
  ...
  let g:airline#themes#github#palette.inactive = extend(g:airline#themes#github#palette.inactive, {
        \ 'airline_warning': [airline#themes#get_highlight('airlineWarning')],
        \ 'airline_error': [airline#themes#get_highlight('airlineError')],
        \ 'airline_term': [airline#themes#get_highlight('airlineTerm')],
        \ })
